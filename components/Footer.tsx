...
export default function Footer() {
  ...
  // The resume page stands on its own, without the site footer.
    ...
    <footer ref={footerRef} className={styles.footer}>
      <div className={`container ${styles.inner}`}>
        <div className={styles.links}>
          <a href="mailto:lav.dsgnr@gmail.com" className={styles.link} data-cuelume-hover="tick">Email</a>
          ...
          <a href="/resume" className={styles.link} data-cuelume-hover="tick">Resume</a>
        </div>
        <svg
